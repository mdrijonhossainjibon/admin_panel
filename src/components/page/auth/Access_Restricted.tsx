...
export default function  Access_Restricted() {
  return (
    <div className="flex min-h-[100dvh] flex-col items-center justify-center bg-background px-4 py-12 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-md text-center">
        ...
        <p className="mt-4 text-muted-foreground">
          We're sorry, but your IP address has been blocked from accessing this website. This is likely due to
          suspicious activity detected from your location.
        </p>
        <p className="mt-4 text-muted-foreground">
